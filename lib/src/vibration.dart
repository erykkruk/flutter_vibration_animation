...
class Vibration {
  ...
  static Future<void> vibrate({
    ...
    return HapticKitChannel.invoke<void>('vibration.oneShot', {
  ...
  static Future<void> vibrateWaveform({
    ...
    return HapticKitChannel.invoke<void>('vibration.waveform', {
  ...
  static Future<void> playPredefined(PredefinedEffect effect) =>
      HapticKitChannel.invoke<void>('vibration.predefined', {
        'effect': effect.name,
      });
